...
// 1. Import the new MusicButton component
// src/components/Header.jsx

// Use './' because MusicButton.jsx is a direct sibling in the same folder.
...
const Header = memo(({ toggleTheme, currentTheme, onHamburgerClick }) => {
  ...
  return (
    ...
    >
      ...
      {/* Desktop Navigation Links (min-[935px]:flex) */}
      <nav className="hidden min-[935px]:flex gap-2 sm:gap-4 md:gap-6 items-center">
        ...
        {/* 2. Add Music Button for Desktop */}
        <MusicButton /> 
      ...
      {/* Mobile/Hamburger Menu (max-[934px]:flex hidden items-center gap-2) */}
      <div className="flex max-[934px]:flex hidden items-center gap-2">
        {/* 3. Add Music Button for Mobile */}
        <MusicButton />
