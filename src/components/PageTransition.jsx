...
const fragmentShader = /* glsl */ `
  ...
  void main() {
    ...
    // Create a pseudo-background using gradients + noise.
    ...
    // mix channels simply (we're not sampling a DOM texture here)
    vec3 final = vec3(colR.r, colG.g, colB.b);
...
export default function PageTransition({ children }) {
  ...
  const overlayVariants = {
    ...
    exit: { opacity: 1, transition: { duration: 0.55, ease: "easeInOut" } },
  };
