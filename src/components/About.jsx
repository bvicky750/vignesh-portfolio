...
// NEW — Import the Spider-Verse Title Component (same as Contact.jsx)
import PageTitle from "../components/PageTitle";

// ⭐ NEW — Import Page Transition Wrapper
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 w-full max-w-5xl px-4 py-12">
          ...
          <motion.div
            ...
            className="
              ...
              before:rounded-full before:bg-radial-gradient
          ...
          >
            ...
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-xl mb-4 text-center md:text-left">
              ...
              trying out creative ideas, and making projects that keep me excited to learn more.
            </p>
