...
// NEW — Spider-Verse Title Component
...
const RESUME_URL = "https://drive.google.com/file/d/1iP_afTrPm6iPWYBKi54YpzVULL8kza0t/preview";
...
export default memo(function About() {
  ...
  return (
    <PageTransition>
      ...
      {/* 🟡 GLOBAL POPUP — now using new system */}
      <PagePopup 
        image={popupConfig.about.image} 
        text={popupConfig.about.text} 
      />
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 w-full max-w-5xl px-4 py-12">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-xl mb-4 text-center md:text-left">
              I’m someone who enjoys exploring tech,
