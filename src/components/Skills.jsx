...
const SKILLS_SECTIONS = [
    ...
    { icon: <Terminal className="w-6 h-6" />, title: "Tools & Platforms", tags: ["Git", "GitHub", "VS Code", "Jupyter Notebook", "Unity"] },
    { icon: <Sparkles className="w-6 h-6" />, title: "Interests", tags: ["Game Development", "DSA", "Machine Learning", "Web Development"] },
];
