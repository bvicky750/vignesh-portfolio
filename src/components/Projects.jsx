...
function ProjectsComponent() {
  const projectsData = useMemo(
    () => [
      { title: "Talent Track", desc: "TalentTrack was my submission for the Smart India Hackathon (SIH), focusing on [Specify the problem/theme of the SIH project, e.g., streamlining student-industry connections, solving a civic issue]. The project involved rapidly prototyping a solution to a real-world problem, demonstrating strong skills in problem-solving, collaboration, and rapid development under time constraints.", tags: ["C++", "LZW Algorithm", "OOPS"], links: [{ type: "code", href: "https://github.com/bvicky750/TalentTrack" }] },
      { title: "Sample-e-Commerce-website", desc: "Developed a sample e-commerce platform to simulate core retail functionalities and demonstrate proficiency in both front-end and back-end development. This project focuses on implementing critical features necessary for an operational online store, emphasizing state management, data security, and efficient transaction processing.", tags: ["C++", "SFML", "Dijkstra's", "A*", "OOPS", "Data Structures"], links: [{ type: "code", href: "https://github.com/bvicky750/sample-e-commerce-site" }] },
      { title: "Vignesh-portfolio", desc: "Developed a responsive and modern personal portfolio website using the React framework. This platform serves as a central hub to showcase my technical skills, educational background, professional experience, and key projects. The goal was to create an engaging, highly performant, and user-friendly interface that adheres to clean design principles.", tags: ["React", "Vite", "JavaScript", "Tailwind CSS", "Codeforces API"], links: [ { type: "code", href: "https://github.com/bvicky750/vignesh-portfolio" }] },
