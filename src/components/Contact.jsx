...
function ContactComponent() {
  ...
  return (
    <PageTransition>
      ...
      {/* 🟡 NEW — Popup Character for Contact Page */}
      <PagePopup
        image={popupConfig.contact.image}
        text={popupConfig.contact.text}
      />
          ...
          >
            ...
            <motion.div variants={itemVariants}>
              <Button
                ...
                className="w-full text-lg font-semibold py-3 flex items-center justify-center gap-2 shadow-md hover:shadow-lg transition-all duration-200 disabled:opacity-50"
              >
